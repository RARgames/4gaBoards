module.exports.routes = {
  ...
  'POST /api/users/find-by-email': 'users/find-by-email',
  ...
  'POST /api/boards/:boardId/templates': 'board-templates/create',
  ...
  'POST /api/cards/:id/mark-completed': 'cards/mark-completed',
