...
module.exports = {
  ...
  async fn(inputs) {
    ...
    if (user) {
      ...
      const isOnlyUsageUpdate = valueKeys.length === 1 && (Object.prototype.hasOwnProperty.call(values, 'lastLogin') || Object.prototype.hasOwnProperty.call(values, 'lastEmailVerificationRequestAt'));
