const Permissions = {
  ...
  USER_FIND_BY_EMAIL: 'users.find-by-email',
  USER_UPDATE: 'users.update',
  USER_UPDATE_EMAIL: 'users.update-email',
  USER_REQUEST_EMAIL_VERIFICATION: 'users.request-email-verification',
  USER_UPDATE_EMAIL_VERIFICATION: 'users.update-email-verification',
  ...
  BOARDTEMPLATE_LIST: 'board-templates.index',
  BOARDTEMPLATE_CREATE: 'board-templates.create',
  BOARDTEMPLATE_UPDATE: 'board-templates.update',
  BOARDTEMPLATE_DELETE: 'board-templates.delete',
