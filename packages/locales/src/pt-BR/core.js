export default {
  translation: {
    common: {
      ...
      boardTemplates: 'Modelos de quadro',
      boardView: 'Painel',
      bug: 'Bug',
      cancel: 'Cancelar',
      ...
      convertToTemplate_title: 'Converter para modelo',
      ...
      currentUsername: 'Nome de usuário: <username>{{username}}</username>',
      ...
      deleteTemplate_title: 'Excluir modelo {{name}}',
      ...
      descriptionShowFullDueDates: 'Mostrar prazos com data e hora. Quando desativado, os prazos completos aparecem apenas nas dicas.',
      ...
      descriptionSuppressedSystemNotificationTags: 'Informe as tags de notificações do sistema que você não deseja receber, separadas por vírgulas, ex. general, releases, security, other.',
      ...
      emailCardToBoard_withCount: 'Enviar Cartão por E-mail para o Quadro <count>({{count}})</count>',
      emailCardToList: 'Enviar Cartão por E-mail para a Lista',
      emailCardToList_withCount: 'Enviar Cartão por E-mail para a Lista <count>({{count}})</count>',
      ...
      enterSystemNotificationTags: 'Informe tags separadas por vírgulas...',
      ...
      hideCompletedLists: 'Ocultar listas concluídas',
      ...
      includeTaskDueDates: 'Incluir datas de vencimento das tarefas',
      inProgress: 'Em Andamento',
      instanceSettings: 'Configurações de Instância',
      justSelectedDay: 'Mostrar Cartões Apenas Para o Dia Selecionado',
      kanban: 'Kanban',
      labels: 'Rótulos',
      labels_one: '{{count}} rótulo',
      labels_other: '{{count}} rótulos',
      language: 'Idioma',
      ...
      markAsNotDone: 'Marcar como não feito',
      ...
      notificationsWithCount: 'Notificações <count>({{unread}}/{{total}})</count>',
      ...
      showCompletedLists: 'Exibir listas concluídas',
      showFewerAttachments: 'Exibir menos anexos',
      showFullDueDates: 'Mostrar Prazos Completos',
      showing: 'Exibindo',
      ...
      suppressedSystemNotificationTags: 'Tags de Notificações do Sistema Suprimidas',
