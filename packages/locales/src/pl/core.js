export default {
  translation: {
    common: {
      ...
      boardTemplates: 'Szablony tablic',
      boardView: 'Tablica',
      bug: 'Błąd',
      cancel: 'Anuluj',
      ...
      convertToTemplate_title: 'Konwertuj na szablon',
      ...
      currentUsername: 'Nazwa użytkownika: <username>{{username}}</username>',
      ...
      deleteTemplate_title: 'Usuń szablon {{name}}',
      ...
      descriptionShowFullDueDates: 'Pokaż terminy z datą i godziną. Gdy wyłączone, pełne terminy są pokazywane tylko w podpowiedziach.',
      ...
      descriptionSuppressedSystemNotificationTags: 'Wpisz tagi powiadomień systemowych, których nie chcesz otrzymywać, oddzielone przecinkami np. general, releases, security, other.',
      ...
      enterSystemNotificationTags: 'Wpisz tagi oddzielone przecinkami...',
      enterTaskDescription: 'Podaj opis zadania...',
      enterTemplateName: 'Wpisz nazwę szablonu...',
      ...
      filterTemplates: 'Filtruj szablony...',
      finance: 'Finanse',
      ...
      hideCompletedLists: 'Ukryj ukończone listy',
      ...
      kanban: 'Kanban',
      labels: 'Etykiety',
      labels_few: '{{count}} etykiety',
      labels_many: '{{count}} etykiet',
      labels_one: '{{count}} etykieta',
      language: 'Język',
      ...
      lists_few: '{{count}} listy',
      lists_many: '{{count}} list',
      ...
      markAsNotDone: 'Oznacz jako niezrobione',
      ...
      showCompletedLists: 'Pokaż ukończone listy',
      showFewerAttachments: 'Pokaż mniej załączników',
      showFullDueDates: 'Pokaż pełne terminy',
      showing: 'Wyświetla',
      ...
      suppressedSystemNotificationTags: 'Wyciszone tagi powiadomień systemowych',
      ...
      today: 'Dzisiaj',
      todo: 'Do zrobienia',
      toggleGlobal: 'Przełącz globalne',
