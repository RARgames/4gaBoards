...
export default {
  ...
  translation: {
    common: {
      ...
      all: 'Všetko',
      allChangesWillBeAutomaticallySaved: 'Všetky zmeny budú automaticky uložené, keď sa spojenie obnoví',
      ...
      email: 'Email',
      emailAlreadyInUse: 'Email je už použitý',
      ...
      noConnection: 'Žiadne pripojenie - prosím, neobnovujte kartu!',
