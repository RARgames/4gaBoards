...
export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateDescription: 'Description mise à jour de <1>{{prevDescription}}</1> à <2>{{description}}</2> pour <0>{{card}}</0>',
      cardUpdateDescriptionShort: 'Description mise à jour de <1>{{prevDescription}}</1> à <2>{{description}}</2>',
      ...
      cardUpdateDescriptionRemove: 'Description <1>{{prevDescription}}</1> supprimée de <0>{{card}}</0>',
      cardUpdateDescriptionRemoveShort: 'Description <1>{{prevDescription}}</1> supprimée de cette carte',
      cardUpdateDueDate: "Date d'échéance mise à jour de <1>{{prevDueDate}}</1> à <2>{{dueDate}}</2> pour <0>{{card}}</0>",
      cardUpdateDueDateShort: "Date d'échéance mise à jour de <1>{{prevDueDate}}</1> à <2>{{dueDate}}</2>",
      ...
      cardUpdateCoverAttachment: 'Pièce jointe de couverture mise à jour de <1>{{prevCoverAttachment}}</1> à <2>{{coverAttachment}}</2> dans <0>{{card}}</0>',
      cardUpdateCoverAttachmentShort: 'Pièce jointe de couverture mise à jour de <1>{{prevCoverAttachment}}</1> à <2>{{coverAttachment}}</2>',
      ...
      cardUpdateCoverAttachmentRemove: 'Pièce jointe de couverture supprimée de <0>{{card}}</0>',
      cardUpdateCoverAttachmentRemoveShort: 'Pièce jointe de couverture supprimée de cette carte',
      ...
      cardTaskUpdateDueDate: "Date d'échéance mise à jour de <2>{{prevDueDate}}</2> à <3>{{dueDate}}</3> pour la tâche <1>{{task}}</1> dans <0>{{card}}</0>",
      cardTaskUpdateDueDateShort: "Date d'échéance mise à jour de <2>{{prevDueDate}}</2> à <3>{{dueDate}}</3> pour la tâche <1>{{task}}</1>",
      cardTaskUpdateDueDateAdd: "Date d'échéance <1>{{dueDate}}</1> ajoutée à la tâche <2>{{task}}</2> dans <0>{{card}}</0>",
      cardTaskUpdateDueDateAddShort: "Date d'échéance <1>{{dueDate}}</1> ajoutée à la tâche <2>{{task}}</2>",
      ...
      cardTaskUserAdd: "Ajouté l'utilisateur <1>{{user}}</1> à la tâche <2>{{task}}</2> dans <0>{{card}}</0>",
      cardTaskUserAddShort: "Ajouté l'utilisateur <1>{{user}}</1> à la tâche <2>{{task}}</2>",
      cardTaskUserRemove: "Supprimé l'utilisateur <1>{{user}}</1> de la tâche <2>{{task}}</2> dans <0>{{card}}</0>",
      cardTaskUserRemoveShort: "Supprimé l'utilisateur <1>{{user}}</1> de la tâche <2>{{task}}</2>",
