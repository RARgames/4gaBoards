...
export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateTimer: 'Minuteur mis à jour de <1>{{prevTimer}}</1> à <2>{{timer}}</2> pour <0>{{card}}</0>',
      cardUpdateTimerShort: 'Minuteur mis à jour de <1>{{prevTimer}}</1> à <2>{{timer}}</2>',
      cardUpdateTimerAdd: 'Minuteur <1>{{timer}}</1> ajouté à <0>{{card}}</0>',
      cardUpdateTimerAddShort: 'Minuteur <1>{{timer}}</1> ajouté à cette carte',
      cardUpdateTimerRemove: 'Minuteur <1>{{prevTimer}}</1> supprimé de <0>{{card}}</0>',
      cardUpdateTimerRemoveShort: 'Minuteur <1>{{prevTimer}}</1> supprimé de cette carte',
