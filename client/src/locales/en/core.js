export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateDescription: 'Updated description from <1>{{prevDescription}}</1> to <2>{{description}}</2> of <0>{{card}}</0>',
      cardUpdateDescriptionShort: 'Updated description from <1>{{prevDescription}}</1> to <2>{{description}}</2>',
      ...
      cardUpdateDescriptionRemove: 'Removed description <1>{{prevDescription}}</1> from <0>{{card}}</0>',
      cardUpdateDescriptionRemoveShort: 'Removed description <1>{{prevDescription}}</1> from this card',
      cardUpdateDueDate: 'Updated due date from <1>{{prevDueDate}}</1> to <2>{{dueDate}}</2> of <0>{{card}}</0>',
      cardUpdateDueDateShort: 'Updated due date from <1>{{prevDueDate}}</1> to <2>{{dueDate}}</2>',
      ...
      cardUpdateCoverAttachment: 'Updated cover attachment from <1>{{prevCoverAttachment}}</1> to <2>{{coverAttachment}}</2> in <0>{{card}}</0>',
      cardUpdateCoverAttachmentShort: 'Updated cover attachment from <1>{{prevCoverAttachment}}</1> to <2>{{coverAttachment}}</2>',
      ...
      cardUpdateCoverAttachmentRemove: 'Removed cover attachment from <0>{{card}}</0>',
      cardUpdateCoverAttachmentRemoveShort: 'Removed cover attachment from this card',
      ...
      cardTaskUpdateDueDate: 'Updated due date from <2>{{prevDueDate}}</2> to <3>{{dueDate}}</3> in task <1>{{task}}</1> in <0>{{card}}</0>',
      cardTaskUpdateDueDateShort: 'Updated due date from <2>{{prevDueDate}}</2> to <3>{{dueDate}}</3> in task <1>{{task}}</1> ',
      cardTaskUpdateDueDateAdd: 'Added due date <1>{{dueDate}}</1> to task <2>{{task}}</2> in <0>{{card}}</0>',
      cardTaskUpdateDueDateAddShort: 'Added due date <1>{{dueDate}}</1> to task <2>{{task}}</2>',
      ...
      cardTaskUserAdd: 'Added user <1>{{user}}</1> to task <2>{{task}}</2> in <0>{{card}}</0>',
      cardTaskUserAddShort: 'Added user <1>{{user}}</1> to task <2>{{task}}</2>',
      cardTaskUserRemove: 'Removed user <1>{{user}}</1> from task <2>{{task}}</2> in <0>{{card}}</0>',
      cardTaskUserRemoveShort: 'Removed user <1>{{user}}</1> from task <2>{{task}}</2>',
