export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateTimer: 'Updated timer from <1>{{prevTimer}}</1> to <2>{{timer}}</2> of <0>{{card}}</0>',
      cardUpdateTimerShort: 'Updated timer from <1>{{prevTimer}}</1> to <2>{{timer}}</2>',
      cardUpdateTimerAdd: 'Added timer <1>{{timer}}</1> to <0>{{card}}</0>',
      cardUpdateTimerAddShort: 'Added timer <1>{{timer}}</1> to this card',
      cardUpdateTimerRemove: 'Removed timer <1>{{prevTimer}}</1> from <0>{{card}}</0>',
      cardUpdateTimerRemoveShort: 'Removed timer <1>{{prevTimer}}</1> from this card',
