export default {
  ...
  translation: {
    common: {
      ...
      descriptionSyncSsoDataOnAuth: 'Enable or disable synchronization of user data (including assigning new 4ga Boards admins) from the SSO provider during authentication.',
