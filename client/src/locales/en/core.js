export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardCommentCreate: 'Added a comment <1>{{comment}}</1> to <0>{{card}}</0>',
      cardCommentCreateShort: 'Added a comment <1>{{comment}}</1>',
      cardCommentUpdate: 'Updated a comment <1>{{prevComment}}</1> to <2>{{comment}}</2> in <0>{{card}}</0>',
      cardCommentUpdateShort: 'Updated a comment <1>{{prevComment}}</1> to <2>{{comment}}</2>',
      cardCommentDelete: 'Deleted a comment <1>{{comment}}</1> from <0>{{card}}</0>',
      cardCommentDeleteShort: 'Deleted a comment <1>{{comment}}</1>',
    },
