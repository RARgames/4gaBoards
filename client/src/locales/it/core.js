export default {
  ...
  translation: {
    common: {
      ...
      all: 'tutto',
      allChangesWillBeAutomaticallySaved: 'Tutte le modifiche verranno salvate automaticamente non appena la connessione sarà ristabilita',
      ...
      noConnection: 'Nessuna connessione - per favore non ricaricare la scheda!',
