...
export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateDescription: 'Zmieniono opis z <1>{{prevDescription}}</1> na <2>{{description}}</2> dla <0>{{card}}</0>',
      cardUpdateDescriptionShort: 'Zmieniono opis z <1>{{prevDescription}}</1> na <2>{{description}}</2>',
      ...
      cardUpdateDescriptionRemove: 'Usunięto opis <1>{{prevDescription}}</1> z <0>{{card}}</0>',
      cardUpdateDescriptionRemoveShort: 'Usunięto opis <1>{{prevDescription}}</1> z karty',
      cardUpdateDueDate: 'Zmieniono termin z <1>{{prevDueDate}}</1> na <2>{{dueDate}}</2> dla <0>{{card}}</0>',
      cardUpdateDueDateShort: 'Zmieniono termin z <1>{{prevDueDate}}</1> na <2>{{dueDate}}</2>',
      ...
      cardUpdateCoverAttachment: 'Zmieniono załącznik okładki z <1>{{prevCoverAttachment}}</1> na <2>{{coverAttachment}}</2> w <0>{{card}}</0>',
      cardUpdateCoverAttachmentShort: 'Zmieniono załącznik okładki z <1>{{prevCoverAttachment}}</1> na <2>{{coverAttachment}}</2>',
      ...
      cardUpdateCoverAttachmentRemove: 'Usunięto załącznik okładki z <0>{{card}}</0>',
      cardUpdateCoverAttachmentRemoveShort: 'Usunięto załącznik okładki z karty',
      ...
      cardTaskUpdateDueDate: 'Zmieniono termin z <2>{{prevDueDate}}</2> na <3>{{dueDate}}</3> w zadaniu <1>{{task}}</1> w <0>{{card}}</0>',
      cardTaskUpdateDueDateShort: 'Zmieniono termin z <2>{{prevDueDate}}</2> na <3>{{dueDate}}</3> w zadaniu <1>{{task}}</1>',
      cardTaskUpdateDueDateAdd: 'Dodano termin <1>{{dueDate}}</1> do zadania <2>{{task}}</2> w <0>{{card}}</0>',
      cardTaskUpdateDueDateAddShort: 'Dodano termin <1>{{dueDate}}</1> do zadania <2>{{task}}</2>',
