...
export default {
  ...
  translation: {
    common: {
      ...
      descriptionSsoRegistration: 'Włącz lub wyłącz rejestrację użytkownika przez SSO. Ten sposób rejestracji pozwala użytkownikom na utworzenie konta przy pomocy konta zewnętrznego np. poprzez konto zewnętrzne (Konto Google).', // eslint-disable-line prettier/prettier
