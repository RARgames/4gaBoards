...
export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardUpdateTimer: 'Zmieniono stoper z <1>{{prevTimer}}</1> na <2>{{timer}}</2> dla <0>{{card}}</0>',
      cardUpdateTimerShort: 'Zmieniono stoper z <1>{{prevTimer}}</1> na <2>{{timer}}</2>',
      cardUpdateTimerAdd: 'Dodano stoper <1>{{timer}}</1> do <0>{{card}}</0>',
      cardUpdateTimerAddShort: 'Dodano stoper <1>{{timer}}</1> do karty',
      cardUpdateTimerRemove: 'Usunięto stoper <1>{{prevTimer}}</1> z <0>{{card}}</0>',
      cardUpdateTimerRemoveShort: 'Usunięto stoper <1>{{prevTimer}}</1> z karty',
