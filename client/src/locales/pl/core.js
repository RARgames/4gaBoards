  ...
  translation: {
    common: {
      ...
      descriptionSsoRegistration:
        'Włącz lub wyłącz rejestrację użytkownika przez SSO. Ten sposób rejestracji pozwala użytkownikom na utworzenie konta przy pomocy konta zewnętrznego np. poprzez konto zewnętrzne (Konto Google).',
      descriptionSubscribeToMyOwnCards: 'Automatycznie subskrybuj karty po stworzeniu.',
      descriptionUserRegistration:
        'Włącz lub wyłącz wszystkie metody rejestracji użytkowników. Jeśli wyłączysz wszystkie metody rejestracji, tylko administratorzy będą mogli tworzyć nowych użytkowników.',
    ...
    action: {
      ...
      backToProject: 'Wróc do projektu',
      cancel: 'Anuluj',
