...
export default {
  ...
  BOARD_TIME_TOTALS_FETCH: `${PREFIX}/BOARD_TIME_TOTALS_FETCH`,
  ...
  CARD_ARCHIVE: `${PREFIX}/CARD_ARCHIVE`,
  CURRENT_CARD_ARCHIVE: `${PREFIX}/CURRENT_CARD_ARCHIVE`,
  CARD_UNARCHIVE: `${PREFIX}/CARD_UNARCHIVE`,

  /* Bulk card actions (multi-select) */

  CARDS_UPDATE: `${PREFIX}/CARDS_UPDATE`,
  CARDS_MOVE: `${PREFIX}/CARDS_MOVE`,
  CARDS_TRANSFER: `${PREFIX}/CARDS_TRANSFER`,
  CARDS_ARCHIVE: `${PREFIX}/CARDS_ARCHIVE`,
  CARDS_DELETE: `${PREFIX}/CARDS_DELETE`,

  /* Card selection */

  CARD_SELECTION_TOGGLE: `${PREFIX}/CARD_SELECTION_TOGGLE`,
  CARD_SELECTION_LIST_TOGGLE: `${PREFIX}/CARD_SELECTION_LIST_TOGGLE`,
  CARD_SELECTION_GROUP_TOGGLE: `${PREFIX}/CARD_SELECTION_GROUP_TOGGLE`,
  CARD_SELECTION_CLEAR: `${PREFIX}/CARD_SELECTION_CLEAR`,
