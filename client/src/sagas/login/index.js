...
export default function* loginSaga() {
  ...
  yield take([ActionTypes.AUTHENTICATE__SUCCESS, ActionTypes.AUTHENTICATE_GOOGLE_SSO__SUCCESS, ActionTypes.AUTHENTICATE_GITHUB_SSO__SUCCESS, ActionTypes.REGISTER__SUCCESS]);
