...
const TablePagination = React.memo(
  React.forwardRef(
    ({ table, itemsPerPage, rowsCount, userPrefsKey, children, className, fitScreen, userPrefsKeys, onResetColumnSorting, onResetColumnWidths, onResetColumnVisibility, onUserPrefsUpdate, ...props }, ref) => {
