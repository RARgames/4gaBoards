...
import { Button, ButtonStyle, Icon, IconType, IconSize, Popup, Form, withPopup, TextArea, TextAreaStyle } from '../Utils';
      ...
      <Popup.Content className={s.content}>
        <Form onKeyDown={handleKeyDown}>
          ...
          <div className={gs.controls}>
            <Button style={ButtonStyle.Submit} content={t('common.addCard')} onClick={(e) => handleSubmit(e.shiftKey)} />
          </div>
        </Form>
      </Popup.Content>
    </>
