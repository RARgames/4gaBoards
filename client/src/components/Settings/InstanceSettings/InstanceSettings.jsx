    ...
    const data = useMemo(
      () => [
        ...
        },
        {
          ...
          modifySettingsProps: { onChange: handleSyncSsoDataOnAuthChange, disabled: demoMode, title: t('common.toggleSyncSsoDataOnAuth') },
        ...
        },
        {
          ...
          modifySettingsProps: { onChange: handleSyncSsoAdminOnAuthChange, disabled: demoMode, title: t('common.toggleSyncSsoAdminOnAuth') },
