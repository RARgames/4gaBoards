      ...
      () =>
        [
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleCompactSidebarChange, title: t('common.toggleItem', { item: t('common.sidebarCompact', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleHideCardModalActivityChange, title: t('common.toggleItem', { item: t('common.hideCardModalActivity', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleHideClosestDueDateChange, title: t('common.toggleItem', { item: t('common.hideClosestDueDate', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleSubscribeToOwnCardsChange, title: t('common.toggleItem', { item: t('common.subscribeToOwnCards', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleSubscribeToNewBoardsChange, title: t('common.toggleItem', { item: t('common.subscribeToNewBoards', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleSubscribeToNewProjectsChange, title: t('common.toggleItem', { item: t('common.subscribeToNewProjects', { postProcess: 'lowercase' }) }) },
          ...
          isAdmin && {
            ...
            modifySettingsProps: { onChange: handleSubscribeToUsersChange, title: t('common.toggleItem', { item: t('common.subscribeToUsers', { postProcess: 'lowercase' }) }) },
          ...
          isAdmin && {
            ...
            modifySettingsProps: { onChange: handleSubscribeToInstanceChange, title: t('common.toggleItem', { item: t('common.subscribeToInstance', { postProcess: 'lowercase' }) }) },
          ...
          },
          {
            ...
            modifySettingsProps: { onChange: handleEmailNotificationsEnabledChange, title: t('common.toggleItem', { item: t('common.emailNotificationsEnabled', { postProcess: 'lowercase' }) }) },
          ...
          emailNotificationsEnabled && {
            ...
            modifySettingsProps: {
              onChange: handleEmailNotificationsMarkReadAsDeliveredChange,
              title: t('common.toggleItem', { item: t('common.emailNotificationsMarkReadAsDelivered', { postProcess: 'lowercase' }) }),
            },
    ...
    const columns = useMemo(
      () => [
        ...
        },
        {
          ...
          cellProps: { ariaLabel: t('common.toggleItem', { item: t('common.settings') }) },
        },
        {
