...
const Timesheet = React.memo(
  ({ currentUserId, isAdmin, users, timeEntries, projects, assignedCards, allCards, categoryTags, accessToken, onFetch, onCreate, onUpdate, onDelete, onFetchCategoryTags, onCreateCategoryTag }) => {
